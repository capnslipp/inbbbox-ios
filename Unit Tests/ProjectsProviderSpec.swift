...
class ProjectsProviderSpec: QuickSpec {
    override func spec() {
        
        var projects: [Project]?
        var sut: ProjectsProviderMock!
        
        beforeEach {
            sut = ProjectsProviderMock()
        }
...
private class ProjectsProviderMock: ProjectsProvider {
