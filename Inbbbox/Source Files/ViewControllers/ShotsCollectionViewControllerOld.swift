...
// NGRTodo: delete this class after refactor
final class ShotsCollectionViewControllerOld: UICollectionViewController {
...
//    NGRTemp: temporary implementation - Maybe we should download shots when the ball is jumping? Or just activity indicator will be enough?
    ...
    convenience init() {
        self.init(collectionViewLayout: InitialAnimationsShotsCollectionViewLayout())
...
private extension ShotsCollectionViewControllerOld {
...
extension ShotsCollectionViewControllerOld: ShotsAnimatorDelegate {
...
extension ShotsCollectionViewControllerOld: ShotCollectionViewCellDelegate {
